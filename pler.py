...
async def help(event):
  helptext = "**Hallo saya adalah protecnya chell. Ada 2 Mode Tag All Cok, Kalo /tagall emot sange + nama user. kalo /all itu random emote tanpa nama user.**"
  await event.reply(
    helptext,
    link_preview=False,
    buttons=(
      [
        Button.url('Owner', 't.me/boys_chellx'),
      ],
      [
        Button.url('Support', 't.me/chellsupportbot'),
        Button.url('Channel', 't.me/mmk_store'),
      ],
    )
  )
